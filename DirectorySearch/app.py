...
if __name__ == "__main__":
    ...
    Hi 👋, I'm **:red[Shubham Shankar]**, and welcome to my **:green[Image Retrival application]**! :rocket: This program makes use of Hugging Face **:orange[Transformers]** model(Metaclip by facebook), 
    ...
    # Directory to search
    input_data_path = st.text_input("Enter the name of directory to search: ")
